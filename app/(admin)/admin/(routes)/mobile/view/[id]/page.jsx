...
import { deleteMultiImage, fetchMobile } from '@/lib/actions/mobile.action';
...

                    {
                        result && (
                            <div className=' mt-5 grid grid-cols-12 p-2 gap-3 md:gap-2'>
                                ...
                                <div className=' col-span-12  md:col-span-6  p-3 text-sm '>
                                    <div>
                                        <span className=' font-bold ' >Playstore Link : </span>
                                        <span><a href={result.playstore} target='_blank'>{result.playstore}</a></span>
                                    </div>
                                </div>
                                <div className=' col-span-12  md:col-span-6  p-3 text-sm '>
                                    <div>
                                        <span className=' font-bold ' >Appstore Link : </span>
                                        <span><a href={result.appstore} target='_blank'>{result.appstore}</a></span>
                                    </div>
                                </div>
                                <div className=' col-span-12  md:col-span-6  p-3 text-sm '>
                                    <div className=' relative w-[100px] h-[100px]'>
                                        <Image src={`/assets/images/${result.logo}`} fill className='object-cover' />
                                    </div>
                                </div>
